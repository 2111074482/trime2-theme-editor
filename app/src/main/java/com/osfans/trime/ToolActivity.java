...
import com.androlua.LuaEditorActivity;
...
public class ToolActivity extends ListActivity implements AdapterView.OnItemLongClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0,1,0,"").setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS).setActionView(mEditText);
        menu.add(0,2,0,"新建").setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==2){
            new EditDialog(this, "输入工具名称", "", new EditDialog.EditDialogCallback() {
                @Override
                public void onCallback(String text) {
                    if(TextUtils.isEmpty(text))
                        return;
                    File f = new File(mDir + text + "/main.lua");
                    if(!f.exists()){
                    ...
                    startActivity(new Intent(ToolActivity.this, LuaEditorActivity.class).setData(Uri.parse(mDir + text + "/main.lua")));
                }
            }).show();
        }
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        new AlertDialog.Builder(this, Config.getDialogTheme())
                .setItems(new String[]{
                        "添加到桌面",
                        "编辑",
                        "删除",
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                new AlertDialog.Builder(ToolActivity.this, Config.getDialogTheme())
                                        .setTitle("确定删除 " + text)
